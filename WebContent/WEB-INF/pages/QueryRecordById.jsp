...
<c:url value="/resources/js/Project/QueryRecordById.js?version=${resourceVersion}" var="modifyQueryRecordByIdJS" />
...
<script src="${modifyQueryRecordByIdJS}" type="text/javascript"></script>
...
<table id="queryRecordById" class="table table-bordered" style="border:2px solid #f3f5f6;table-layout:fixed;">
						<thead>
						 <tr><td colspan="7"  align=center><B>實時門禁</B></td></tr>
						<tr>
...
<table id="queryInfoById" class="table table-bordered" style="border:2px solid #f3f5f6;table-layout:fixed;">
						<thead>
						 <tr><td colspan="7"  align=center><B>大門門禁</B></td></tr>
						<tr>
								<th style="width: 8%; text-align:center;">部門ID</th>
								<th style="width: 6%; text-align:center;">部門名稱</th>			
								<th style="width: 10%; text-align:center;">工號</th>
								<th style="width: 10%; text-align:center;">姓名</th>
								<th style="width: 18%; text-align:center;">門禁時間</th>
								<th style="width: 10%; text-align:center;">門禁地點</th>
								<th style="width: 5%; text-align:center;">數據寫入時間</th>
							</tr>
						</thead>
						  <tbody>
    <!--  <tr>
