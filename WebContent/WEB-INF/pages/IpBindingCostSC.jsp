...
<c:url value="/resources/js/Project/RealTime.Modify.IpBindingCostSC.js?version=${resourceVersion}" var="IpBindingCostSC" /> 
...
<script src="${IpBindingCostSC}" type="text/javascript"></script>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>維護卡機可刷卡費用代碼</title>
</head>
		...
		<div class="panel-body" style="border: 1px solid #e1e3e6;">
			<div align="right">
				查詢條件：<select id="queryCritirea" class="input-small">
					...
					id="searchIpBindingCostSC" name="searchIpBindingCostSC"
			...
			<div class="middle">
				<div class="left" style="width:80%;height:730px;float:left;border:1px solid #f3f5f6;padding:10px 10px;position: relative;" >
					<table id="IpBindingCostSCInfoTable" class="table table-hover" style="border:2px solid #f3f5f6;table-layout:fixed;">
						<thead>
							<tr>
								<th>卡機ip</th>
								<th>費用代碼</th>
					...
					<div id="IpBindingCostSCInfoListPagination" align="right" style="height: 20;position:absolute; bottom: -20px;right: 0px;">
					</div>
				</div>
			</div>
			<jsp:include page="InsertIpBindingCostSC.jsp" />
		</div>
	</div>
</div>	
</body>
