	...
	<div style="top: 55px; margin-left: 10px">
		<div class="panel-body" style="border: 1px solid #e1e3e6;">
			...
			<div>
					...
					<a id="addNewIOCardMaIP" role="button" href="#insertIOWorkShopPW"class="btn btn-sm" data-toggle="modal" style="position: absolute;top: 50px;right: 500px;font-size: 14px;"><i class="glyphicon glyphicon-plus"></i>創建新車間休息時間段</a>
			</div>
			<div class="middle">
