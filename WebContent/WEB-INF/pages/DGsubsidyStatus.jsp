...
<c:url value="/resources/js/Project/DGsubsidyStatus.js?version=${resourceVersion}" var="DGsubsidyStatusJS"></c:url>
...
<script src="${DGsubsidyStatusJS }" type="text/javascript"></script>
