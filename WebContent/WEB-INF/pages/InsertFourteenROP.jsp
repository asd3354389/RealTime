...
<div id="insertFourteenROP" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm ins" >
		...
		<div class="control-group">
    		...
    		<div class="controls">
      			<input type="text" id="inputId" name="inputId" class="required form-control" placeholder="工號">
    		</div>
  		</div>
