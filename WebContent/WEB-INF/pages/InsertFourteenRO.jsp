...
<div id="insertFourteenRO" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm ins" >
		...
		<div class="control-group"><label for="outCard" style="color:red">多個費用代碼之間用英文,（逗號）隔開，如132456,123456</label></div>
		<div class="control-group">
    		<label class="control-label" for="inputUserName">費用代碼</label>
    		<div class="controls">
      			<input type="text" id="inputCostid" name="inputCostid" class="required form-control" placeholder="費用代碼">
    		</div>
  		</div>
        ...
        <br>
  		<button type="submit" id="setFourteenRO" class="btn btn-primary">設置</button>
