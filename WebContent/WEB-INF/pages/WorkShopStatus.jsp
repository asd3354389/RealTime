	...
	<div style="top: 55px; margin-left: 10px">
		<div class="panel-body" style="border: 1px solid #e1e3e6;">
			<div align="right">
				...
				</select><select id="changeWorkShopNo" name="changeWorkShopNo"><option value=''></option></select><input type="button"
						...
						<div class="control-group">
					    	<div class="controls">
					      			<label for="workShopNo">車間號</label>
					    					<select id="workShopNo" name='workShopNo' class="form-control">
					    						<option value=""></option>
					    					</select>  			
		    				</div>
		  					
				    		<div class="controls">
				      			<label for="linkNo">綫體號</label>
				    					 <select id="lineNo" name="lineNo" class="selectpicker show-tick form-control" multiple data-live-search="true"></select>  			
	    					</div>
	  					...
	  					<button type="submit" id="setWorkShopStatus" class="btn btn-primary" style="margin-top: 10px;">設置</button>	
  					</div>
				</div>
		</div>
	</div>
