	...
	<div id="mainPanle" region="center"
		...
		<div id="tabs" class="easyui-tabs" fit="true" border="false">
			<div title="欢迎使用" style="padding: 20px; overflow: hidden;" id="home">
				...
				<h1 style="color:red;">加班拋轉系統請使用<img src="./resources/images/chromeicon.jpg" alt='谷歌瀏覽器圖標！'/>谷歌瀏覽器拋轉，請不要使用<img src="./resources/images/ieicon.png" alt='ie瀏覽器圖標！'/>IE，<img src="./resources/images/firefoxicon.jpg" alt='火狐瀏覽器圖標！'/>火狐等瀏覽器。如沒有谷歌瀏覽器請聯繫林東平36908，陳健文31013，劉峰君31007進行谷歌瀏覽器的安裝，或者自行點擊下方藍色字體下載相對應的谷歌瀏覽器。否則出現報加班的問題請自行用聯絡單修改。</h1>
				<div>
