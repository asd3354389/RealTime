...
public class WorkshopABExcelUtils {
	public String[] title = {"工號","姓名","費用代碼","組別代碼","線別代碼","部門名稱","異常時間段","異常時間（分鐘）"};
	public int[] cellWight = {5000 ,4000 ,4000 ,4000 ,5000,20000,5000,5000 };

	public InputStream creatExcel(List<AccessAB> abList,String sheetName) throws Exception{
			...
			for(int i = 1;i<abList.size()+2;i++){
				...
				if(i==1){
					...
					AccessAB accessAB = abList.get(i-2);
					HSSFCell cell=row.createCell(0);
					cell.setCellValue(accessAB.getId());
					HSSFCell cell1=row.createCell(1);
					cell1.setCellValue(accessAB.getName());
					HSSFCell cell2=row.createCell(2);
					cell2.setCellValue(accessAB.getCostid());
					HSSFCell cell3=row.createCell(3);
					cell3.setCellValue(accessAB.getDeptid());
					HSSFCell cell5=row.createCell(4);
					cell5.setCellValue(accessAB.getDepid());
					HSSFCell cell6=row.createCell(5);
					cell6.setCellValue(accessAB.getDeptname());
					HSSFCell cell7=row.createCell(6);
					cell7.setCellValue(accessAB.getInterval());
					HSSFCell cell8=row.createCell(7);
					cell8.setCellValue(accessAB.getTime());
					...
					if(i == abList.size()+1){
						...
						cell8.setCellStyle(cellStyleBottomRight);
					}else{
