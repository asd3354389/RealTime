...
import com.foxlink.realtime.model.objectMapper.QueryDGsubsidyStatusMapper;
import com.foxlink.realtime.model.objectMapper.QueryOTMapper;
import com.foxlink.realtime.model.objectMapper.UserMapper;

//@Repository
public class DGsubsidyStatusDAO  extends DAO<QueryStatus>{
	public DGsubsidyStatusDAO() {
		super();
	}
	...
	// 获取总记录数
		...
		public int getTotalRecords(String userDataCostId,QueryStatus queryStatus) {
			int totalRecord = -1;
			String sSql = "select count(*) from SWIPE.notes_overtime_state where 1=1 AND BONUS != 0  AND NOTESSTATES_B = 1";
			...
			try {
				...
				System.out.println("总记录数sql"+sSql);
