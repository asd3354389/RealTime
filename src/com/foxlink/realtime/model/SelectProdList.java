...
public class SelectProdList {
		...
		public String toString() {
			return "SelectProdList [RECORDID=" + RECORDID + ", PLAN_DATE_YEAR=" + PLAN_DATE_YEAR + ", SHIFT=" + SHIFT
					+ ", DEPID=" + DEPID + ", PROD_NAME=" + PROD_NAME + ", PROD_CODE=" + PROD_CODE
					+ ", NUMBER_OF_PEOPLE=" + NUMBER_OF_PEOPLE + ", PLAN_DATE_WEEK=" + PLAN_DATE_WEEK + ", COSTID="
					+ COSTID + "]";
		}
